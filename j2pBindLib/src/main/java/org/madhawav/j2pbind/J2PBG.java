...
import org.madhawav.j2pbind.javagen.JavaCodeGen;
import org.madhawav.j2pbind.javagen.JavaWriter;
import org.madhawav.j2pbind.pygen.PythonCodeGen;
import org.madhawav.j2pbind.pygen.PythonWriter;
...
public class J2PBG {
    ...
    private static Logger logger = Logger.getLogger(J2PBG.class.getName());
    ...
    private void copyJniusClass(){
        ...
        InputStream fileInputStream = classLoader.getResourceAsStream("jnius_util/NativeInvocationHandler.java");
