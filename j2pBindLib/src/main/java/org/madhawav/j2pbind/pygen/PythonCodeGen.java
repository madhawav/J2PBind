...
{
    private List<Class> inScopeClasses;

    public PythonCodeGen(){
        this.inScopeClasses = new ArrayList<>();
    }

    public List<Class> getInScopeClasses() {
        return inScopeClasses;
    }

    public void generateProxyClass(Class input, PythonWriter writer, String pythonPrefix){
    ...
    public void generateDirectProxyClass(Class input, PythonWriter writer, String pythonPrefix){
    ...
    public void generateProxyCallbackClass(Class input, PythonWriter writer){
    ...
    public boolean isProxyAvailable(Type t){
        if(this.inScopeClasses.contains(t)){
            return true;
        }
        return false;
    }
