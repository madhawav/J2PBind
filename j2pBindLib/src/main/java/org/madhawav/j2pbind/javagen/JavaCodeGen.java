...
public class JavaCodeGen {
    public void generateProxyCode(Class input, JavaWriter writer){
    ...
    public void generateCallbackInterfaceCode(Class input, JavaWriter writer){
        writer.write("package proxy." + input.getPackage().getName() + ";");
