...
import org.madhawav.j2pcg.Config;
import org.madhawav.j2pcg.J2PCG;
...
public class J2PCGTest {
    ...
    public void generateSourceFilesAndCompile() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        J2PCG j2PCG = new J2PCG(config);
        j2PCG.generateSourceFiles();
        j2PCG.compileJavaFiles();
        j2PCG.generateLoader();
    ...
    private static void copyResourceToFile(String resourcePath, String filePath) {
        ClassLoader classLoader = J2PCGTest.class.getClassLoader();
